    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Remplissez les informations du projet</p>
        </div>
        <Link href="/projects" className="inline-flex items-center space-x-2 text-muted-foreground hover:text-foreground transition-colors">
          <ArrowLeft size={20} />
          <span>Retour</span>
        </Link>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-card rounded-lg border border-border p-6">
        ...
        <div className="flex gap-3 mt-8 pt-6 border-t border-border">
          ...
          <Link href="/projects" className="inline-flex items-center gap-2 px-6 py-2 bg-muted hover:bg-secondary text-foreground font-semibold rounded-lg transition-colors">
            Annuler
          </Link>
        </div>
      </form>
