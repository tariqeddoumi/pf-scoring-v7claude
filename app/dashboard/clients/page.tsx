...
export default function ClientsPage() {
  ...
  const { mutate: createClient, loading: creatingClient, error: createError } = useMutation(
    '/api/clients',
    'POST'
  );
  ...
  const columns: Array<{ key: keyof Client; label: string; render?: (value: any) => React.ReactNode }> = [
