          ...
          criteria: [
            {
              ...
              scale: {
                ...
                levels: [
                  ...
                  { value: 3, label: "No SPV / Mixed activities" },
                ],
              },
              redFlagThreshold: 3,
              noGoThreshold: 1,
            },
            {
              ...
              scale: {
                ...
                levels: [
                  ...
                  { value: 3, label: "Missing contracts" },
                ],
              },
              redFlagThreshold: 3,
              noGoThreshold: 1,
            },
            {
              ...
              scale: {
                ...
                levels: [
                  ...
                  { value: 3, label: "Poorly allocated" },
                ],
              },
              redFlagThreshold: 4,
              noGoThreshold: 2,
            ...
            },
            {
              ...
              scale: {
                ...
                levels: [
                  ...
                  { value: 3, label: "Land not secured" },
                ],
              },
              redFlagThreshold: 3,
              noGoThreshold: 1,
            },
            {
              ...
              scale: {
                ...
                levels: [
                  ...
                  { value: 3, label: "Strong opposition" },
                ],
              },
              redFlagThreshold: 4,
              noGoThreshold: 2,
