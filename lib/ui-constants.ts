...
export const BUTTON_STYLES = {
  primary: 'bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded-lg transition-all',
  secondary: 'bg-slate-700 hover:bg-slate-600 text-white font-semibold px-4 py-2 rounded-lg transition-all',
  danger: 'bg-red-600 hover:bg-red-700 text-white font-semibold px-4 py-2 rounded-lg transition-all',
  outline: 'border border-slate-700 rounded-lg text-slate-400 hover:text-white hover:border-slate-600 transition-colors px-4 py-2',
};

// Common Input Styles
export const INPUT_STYLES = {
  default: 'w-full px-4 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500',
  error: 'w-full px-4 py-2 bg-slate-700 border border-red-500 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500',
};
